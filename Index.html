...
<html>
    ...
    <body>
        <div id="top">
            <div id="logo">JP</div>
            <div id="logo-name">Jannik Philippin</div>
            <div id="navigation">
                <a href="#about-me">Über mich</a>
                <a href="#sport">Sport</a>
                <a href="#drawing">Zeichnen</a>
                <a href="#guitar">Gitarre</a>
        ...
        <div id="main">
            <section id="about-me"><h2 style="color:rgb(52, 20, 112)">Über mich</h2>
                <p>Ich bin Jannik Philippin, 19 Jahre alt und möchte dieses Jahr eine Ausbildung zum Fachinformatiker beginnen. Im Folgenden möchte ich Sie gerne an meinen Hobbies und Interessen teilhaben lassen. Soziale Netzwerke habe ich nicht verlinkt, da ich nur Whatsapp und Instagram regelmäßig nutze, aber dort nicht als öffentlich Person auftrete und keine persönlichen Inhalte hochgeladen habe.</p>
                <p>Warum eine Ausbildung zum Fachinformatiker?</p>
            ...
            <section id="drawing"><h2 style="color:rgb(52, 20, 112)">Zeichnen</h2>
                <p>Eine weitere Leidenschaft von mir ist das Zeichnen. Zu meinen liebsten Motiven gehören Autos, vor allem Oldtimer und Sportwagen, da ich ein großer Fan davon bin. Außerdem zeichne ich des Öfteren Gebäude im Sketch-Stil.</p>
                <p>Ebenfalls habe ich mich vor ein paar Jahren mit dem digitalen Zeichnen mithilfe von Software und Zeichen-Tablet beschäftigt. Jedoch habe ich das nicht weiterverfolgt, da die Software und ein gutes Tablet zu teuer für mich waren.</p>
                <p>Allerdings bin ich in der Lage Logos usw. für meine Webseiten mit Photoshop zu entwerfen.</p>
            </section>
            <section id="guitar"><h2 style="color:rgb(52, 20, 112)">Gitarre</h2>
                <p>Über mehrere Jahre besuchte ich den Gitarrenunterricht der Jugendmusikschule. Anfangs habe ich ausschließlich klassische Stücke gespielt, wie es typisch für Beginner ist. Mit der Zeit fing ich an die spanische Gitarre zu favorisieren. Ich bewundere Flamenco Spieler wie <a href="https://www.youtube.com/watch?v=L9NCvSakgR8">Antonio Muñoz Fernández</a>, der seine Gitarre blind beherrscht und versuche mich ebenfalls auf spanische Stücke zu spezialisieren.</p>
            </section>
        ...
        <div id="footer">
            Copyright 2020 - Jannik Philippin
        </div>
    </body>
</html>
